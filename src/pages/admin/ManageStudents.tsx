...
import { Plus, Trash2, Edit, GraduationCap, Search, MessageCircle } from 'lucide-react';
...
export function ManageStudents() {
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="inline-flex items-center gap-1 px-2.5 py-1 text-xs font-semibold rounded-lg bg-indigo-50 text-indigo-700 hover:bg-indigo-100 disabled:opacity-50 disabled:cursor-not-allowed"
              >
  ...
  function handleSendWhatsApp(parent: User) {
    ...
    if (!phone || !parent.email || !parent.password) {
      addToast({
        type: 'error', title: 'Parent must have phone, email and password',
      });
      return;
    }
    ...
    <div className="space-y-6">
      ...
      {error && (
        <div className="text-center py-12">
          ...
          <button onClick={() => refresh()} className="mt-4 px-4 py-2 bg-indigo-600 text-white rounded-xl text-sm hover:bg-indigo-700">
            Retry
          </button>
        </div>
      )}
